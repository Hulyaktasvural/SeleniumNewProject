...
public class C01_Xpath {
    public static void main(String[] args) {
       ...
       // WebElement aramaKutusu = driver.findElement(By.xpath("//*[@name='field-keywords']"));
        ...
        WebElement sonuçYazısı = driver.findElement(By.xpath("(//*[@class='sg-col-inner'])[1]"));
        System.out.println(sonuçYazısı.getText());
        //16 results for "city bike" bu yazının locate'ini aldık.
        String [] sonuçSayısı =sonuçYazısı.getText().split(" ");
        System.out.println("Sonuç Sayısı = "+sonuçSayısı[0]);
